...
/*   Updated: 2022/07/26 20:26:15 by austin00720      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
router.post('/getPrepayId', async function (req, res) {
  ...
  var config = {
    headers:{
      Authorization: `WECHATPAY2-SHA256-RSA2048 mchid="1628040916",nonce_str="${nonceStr}",signature="${signature.toString()}",timestamp="${timestamp.toString()}",serial_no="${serial_no.toString()}"`
    }
  }
